...
export default function TOS() {
    return (
        ...
        >
            <Head>
                <title>TOS | TBAUnofficial</title>
                <meta
                    name="description"
                    content="TOS | TBAUnofficial | Developed by FRC member Brandon [@BrandgrandReal] for other FRC members to fetch information from TBA and my own DB."
                />
            ...
            <div className="tos">
                <div className="tosText">
                    ...
                    <ol>
                        <li><b>Acceptance of Terms:</b> This document outlines the terms and conditions of using the TBAUnofficial Discord bot. By accessing, installing, or using the TBAUnofficial Discord bot, you are agreeing to abide by these terms and conditions. If you do not agree with any of these stipulations, you are prohibited from using this bot.</li>
                        <li><b>Functionality and Usage:</b> The TBAUnofficial bot is designed to pull data from a website called TBA and facilitate users in uploading images to a proprietary database. The bot is provided as is, and its usage is subject to these terms of service. You agree not to misuse the bot or use it for any illegal or unauthorized purposes.</li>
                        ...
                        <li><b>Limitation of Liability:</b> The creators and maintainers of the TBAUnofficial bot shall not be held responsible or liable for any damage, loss of data, or other unforeseen consequences that may occur as a direct or indirect result of using this bot. Users are advised to use the bot at their own risk.</li>
                    ...
                    <br />
                    <p>By using the TBAUnofficial bot, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.</p>
                </div>
            </div>
            <Footer />
        </motion.div>
